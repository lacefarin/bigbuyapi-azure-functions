...
namespace BigBuyApi
{
    public class SyncProducts
    {
        ...
        {
            var result = await _productService.GetAllProductsWithPriceLargeQuantities(SelectedTaxonomy.HealthAndPersonalCare);
        ...
        public class OutputType
        {
            ...
            public List<PriceLargeQuantity>? PriceLargeQuantities { get; set; }
